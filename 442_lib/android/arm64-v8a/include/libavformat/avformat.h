...
av_probe_input_format2(ff_const59 AVProbeData *pd, int is_opened, int *score_max);
 ...
 */
ff_const59 AVInputFormat *
av_probe_input_format3(ff_const59 AVProbeData *pd, int is_opened, int *score_ret);
 ...
 */
int avformat_open_input(AVFormatContext **ps, const char *url, ff_const59 AVInputFormat *fmt,
